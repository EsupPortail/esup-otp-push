class MigrationManager {
    ...
    async isAppInitialized() {
      ...
      return initialized; // Convertit en booléen
    }
    ...
    async initializeApp() {
      ...
      await this.setSharedPreference("establishments", "[]"); // Tableau vide pour les établissements
    ...
    getSharedPreference(key) {
      return new Promise((resolve) => {
        this.sharedPreferences.get(
          ...
          (error) => {
            console.error(`⚠️ - MigrationManager - Erreur lors de la récupération de ${key}:`, error);
            resolve(null);
          }
        );
      });
    ...
    setSharedPreference(key, value, successCallback, errorCallback) {
      return new Promise((resolve, reject) => {
        try {
          ...
          console.error(`⚠️ - MigrationManager - Erreur interne lors du stockage de ${key}:`, error);
          reject(error);
        }
      });
    }
